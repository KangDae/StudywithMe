...
//						+ userContent[1] + "')";
					...
					// 방 생성했을때 폴더에 txt파일 추가
					String Roomtxt = "C:\\Users\\유미\\eclipse-workspace\\prototype\\testrep-main\\roomFolder\\"
							+ priNumber + "\\Roomtxt.txt";
...
//					try {
//						// 파일 객체 생성
//						File file = new File(Roomtxt);
//						//채팅방에 입력할때마다 txt에 저장
//						while (true) {
//							String txt = user.getIdName()+ br.readLine();
...
//					}
					...
					// server부분
//					try {
//						BufferedWriter fw = new BufferedWriter(new FileWriter(Roomtxt, true));
//						while (true) {
...
//							// 메모장에 출력
//							fw.write(user.getIdName() + br.readLine() + "\n");
//							fw.flush();
//						}
//						// 객체 닫기
//						// fw.close();
